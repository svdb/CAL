...
class adminPostList extends adminGenericList
{
	...
	private function postLine()
	{
		...
		switch ($this->rs->on_home_page) {
			case 1:
				$img_OnHpage = sprintf($img,'on home page','check-on.png');
				break;
			case 0:
				$img_OnHpage = sprintf($img,'not on home page','check-off.png');
				break;
		}

		switch ($this->rs->is_new) {
			case 1:
				$img_IsNew = sprintf($img,'New!','check-on.png');
				break;
			case 0:
				$img_IsNew = sprintf($img,'old','check-off.png');
				break;
		}
		...
		'<td class="nowrap status">'.$img_OnHpage.'</td>'.
		'<td class="nowrap status">'.$img_IsNew.'</td>'.
		'</tr>';
